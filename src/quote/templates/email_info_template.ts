export const quoteNotificationTemplate = `<!-- templates/quote-confirmation-template.html -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>A new Quote is requested</h1>
        </div>

        <div class="content">
            <p style="color:#333">A New Quote has been created with following Data:</p>
            ...
            <p style="color:#333"><strong>Additional Info:</strong>{{additionalInfo}}</p>
            <p><strong>Date Created:</strong> {{dateCreated}}</p>
            <p style='color:black;'><strong>Total Amount:</strong> {{amount}}</p>
            <p style="color:#333">Further details can be accessed from backoffice dashboard.</p>    
        </div>
